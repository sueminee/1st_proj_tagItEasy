...
class Post extends Component {
  render() {
    return (
      ...
      {console.log("안녕 i am in SEARCH render and this is this.state", this.state)}
          ...
          <div className="search-left">
            <div className="search-url">
              <div>
                ...
                <input className="input-url" type="text" name="url" placeholder="Copy URL and Paste it here!" onChange={this.props.urlChange}/>
              </div>
              <div>
                <label className="label-url">title</label>
                <input className="input-url" id="make-less" type="text" name="description" placeholder="Write description for this URL" onChange={this.props.desChange}/>
              </div>
            </div>
            <div className="tags">
              <label className="label-tag">tag</label>
              <input className="input-tag" type="text" name="tag1" placeholder="enter tag1" onChange={this.props.tag1Change}/>
              <input className="input-tag" type="text" name="tag2" placeholder="enter tag2" onChange={this.props.tag2Change}/>
              <input className="input-tag" type="text" name="tag3" placeholder="enter tag3" onChange={this.props.tag3Change}/>
            </div>
          </div>
